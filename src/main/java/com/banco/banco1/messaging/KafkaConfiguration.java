...
public class KafkaConfiguration {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaFactory(){
        ...
        kafkaFactory.setConsumerFactory(consumidor());

        return kafkaFactory;
    }

    private ConsumerFactory<String, String> consumidor() {
    ...
    public KafkaTemplate<String, String> kafkaTemplate(){
        return new KafkaTemplate<>(produtor());
    }

    private ProducerFactory<String, String> produtor() {
        Map<String, Object> props = new HashMap<>();
