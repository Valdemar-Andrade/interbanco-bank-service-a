...
import com.banco.banco1.controllers.ContaController;
import com.banco.banco1.dto.ContaDTO;
import com.banco.banco1.dto.SaldoDTO;
...
import com.banco.banco1.services.implementacao.TransacaoServiceServiceImpl;
import com.banco.banco1.utils.ArrayTransacaoManipulator;
...
public class KafkaConsumidor {
    ...
    @KafkaListener(topics="interban", groupId = "interban.group.banco1")
    public void consumidor(String mensagemJson) throws JsonProcessingException {
        ...
        try{
            ...
            //A mensagem veio do intermediario para o Banco A (Eu)
            if (transacaoDTO.getEstado().equalsIgnoreCase("intermediario_0040")){

                //Verificar se existe
                for (TransacaoDTO t: ArrayTransacaoManipulator.listarTransacoes()){
                    ...
                    if (t.getTransationalID().equals(transacaoDTO.getTransationalID())){
                        ...
                        System.out.println("Transacao sucesso A para A - valor: " + t.getValor() + " - CAF dest: " + t.getCaf_destino());
                ...
                if(!originouAqui){
                    ...
                    service.creditar(transacaoDTO.getValor(), transacaoDTO.getIbanDestino());
                    System.out.println("Transacao sucesso BFA para BAI(eu) - valor: " + transacaoDTO.getValor() + " - UID: " + transacaoDTO.getTransationalID());
            ...
            //Erros
            if (transacaoDTO.getEstado().equalsIgnoreCase("intermediario_0040_erro")){
            ...
            //intermediario_bai_consulta
            if (saldoDTO != null && saldoDTO.getEstado().equalsIgnoreCase("intermediario_0040_consulta")){

                ContaDTO conta = ContaController.toDTOOne(service.findById(saldoDTO.getPk_conta()));

                saldoDTO.setEstado("0040_intermediario_consulta");
